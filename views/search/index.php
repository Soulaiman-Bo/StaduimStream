...
<html>
  ...
  <body>
    ...
    <div class="w-full md:w-2/3 mx-auto shadow p-5 rounded-lg bg-white mt-12">
      <div class="relative">
    ...
    <section class="mt-20 mb-20">
      <div
        ...
        <a href="/" class="cursor-pointer">
          <span
            class="h-14 w-36 flex items-center justify-center rounded-full text-gray-100 text-lg hover:bg-orange-600 bg-orange-500"
            >Buy Ticket</span
          >
        </a>
      </div>
