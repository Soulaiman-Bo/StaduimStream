...
<html>
  ...
  <body>
    ...
    <section class="backgroundImagePattern1 " style="width: 1474px;
    height: 481px;"  >
     
      <div class="flex justify-around p-5" style="color: white;width: 1474px;
      height: 481px;" >
          ...
          <div class="flex flex-col items-center justify-center gap-1 ">
            <span class="text-xl">SUN 13 JAN 2023</span>
            <span class="border-4 p-5 text-5xl mb-10  ">21:00</span>
...
<html>
  ...
  <body>
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-3 text-2xl">
          <img
            class="h-24"
            src="http://staduimstream.test/public/images/Guinée-Bissau.png "
            alt=" Guinea-Bissau"
          />
    ...
    <section class="" style="padding-top: 10rem; padding-left: 5rem;">
      ...
      <div class="flex flex-col">
        <span class="rounded-full">Buy Tickets</span>
        <img src="http://staduimstream.test/public/images/cart.svg" alt="cart">
      </div>
    </div>
    </section>
