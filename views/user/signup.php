...
<header>
    ...
    <div class="container py-24 mx-auto ">
        <div class="lg:flex">
            <div class="lg:w-1/2">
                <!-- <img  class="img absolute top-[-160px]" src="imges/Background.png" alt=""> -->
                <h1 class="Signup mt-4">
                    Sign Up<br> In to 
                    Recharge <br>
                    Direct
                </h1>
            ...
            <div class="mt-8 lg:w-1/2 lg:mt-0">
                <form class="form w-full lg:max-w-xl"  method="POST" action="http://staduimstream.test/user/signupaction">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-3 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <input type="text" name="Lastname" class="block w-full py-6 text-gray-700 bg-white border rounded-lg px-11   focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Last Name">
                    </div>
                    ...
                    <div class="relative flex items-center mt-4">
                        <span class="absolute">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-3 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 3h16a2 2 0 012 2v16a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2zm2 0l5 7-1.5 1-2.5-2V17h5v-3.5l-2.5 2-1.5-1 5-7H6zm7 9h2"></path>
                        </svg>
                    ...
                    <div class="relative flex items-center mt-4">
                        ...
                        <input type="password" name="vrfypassword" class="block w-full px-10 py-6 text-gray-700 bg-white border rounded-lg   focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password Confirmation">
                    </div>

                    <div class="mt-8 md:flex md:items-center">
                        <button   id="signin" class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg md:w-1/2  focus:outline-none ">
                            Sign Up
                        </button>
        ...
        <div class="mt-8 md:mt-24 sm:flex sm:items-center">
            <h3 class="andertitle text-blue-500 dark:text-blue-400 sm:w-1/2"> </h3>
